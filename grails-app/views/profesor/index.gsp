...
<html>
  ...
  <body>
    ...
    <div class="container">
      <g:link action="create" class="btn btn-outline-dark">Crear nuevo profesor</g:link>
    </div>
    <style media="screen">
      .paginate a {
        color: black;
      ...
      <div class="row justify-content-center">
        <div class="col text-center paginate">
          <g:paginate next="Forward" prev="Back"
                    maxsteps="10" controller="profesores"
                    action="index" total="${profesoresCount}" class="mx-auto"/>
        </div>
      </div>
    </div>
  </body>
